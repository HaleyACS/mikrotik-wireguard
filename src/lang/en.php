...
return [
    ...
    'js.qrcode_title'         => 'WireGuard client configuration QR code',
    'js.qrcode_alt'           => 'QR code containing the WireGuard client configuration',
    'js.qrcode_error'         => 'Unable to generate the QR code.',
